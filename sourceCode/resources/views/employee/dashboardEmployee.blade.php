                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-box bg-gO">
                            <div class="inner">
                                <h3> ( {{ $allShippers }} ) </h3>
                                <p> Number Of Shippers </p>
                            </div>
                            <div class="icon">
                                <i class="fa-solid fa-user-tie"></i>
                            </div>
                            <a href="shippers" class="card-box-footer">View More <i
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-box bg-gO">
                            ...
                            <a href="{{ route('employee.categories.index') }}" class="card-box-footer">View More <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-box bg-rE">
                            ...
                            <a href="{{ route('employee.reviewsAdmin.index') }}" class="card-box-footer">View More <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
