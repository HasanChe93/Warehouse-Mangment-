...
@section('content')
    <div class="container">
        ...
        <a class="btn btn-success" href="{{ route('employee.products.create') }}">Add Product</a>
        <a href="{{ route('employee.dashboard') }}" class="btn btn-secondary btn-sm float-end"> Go Back</a>
        <br><br>
