        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4">
                <div class="bg-primary rounded p-4">
                    <a href="index.html">
                        <h1 class="text-white text-uppercase mb-3">Aden Warehouse</h1>
                    </a>
                    <p class="text-white mb-0">
                        <a class="text-dark fw-medium" href="index">Aden Warehouse</a>, Our warehouse is dedicated to providing our customers with only the highest quality
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Qastal, Amman-Jordan</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+962796969692</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@Aden-WH.com</p>
            ...
            <div class="col-lg-5 col-md-12">
                <div class="row gy-5 g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <a class="btn btn-link" href="Food&Restaurant">Food & Restaurant</a>
                        <a class="btn btn-link" href="Spa&Fitness">Spa & Fitness</a>
                        <a class="btn btn-link" href="Sports&Gaming">Sports & Gaming</a>
                        <a class="btn btn-link" href="Event&party">Event & Party</a>
                        <a class="btn btn-link" href="GYM&Yoga">GYM & Yoga</a>
                        </div>
                </div>
            </div>
        </div>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Aden Warehouse</a>, All Right Reserved.
